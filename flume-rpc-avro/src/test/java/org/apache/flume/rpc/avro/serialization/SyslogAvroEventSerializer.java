...
public class SyslogAvroEventSerializer extends AbstractAvroEventSerializer<SyslogEvent> {
    ...
    private static final DateTimeFormatter dateFmt1 = DateTimeFormatter.ofPattern("MMM dd HH:mm:ss");
    private static final DateTimeFormatter dateFmt2 = DateTimeFormatter.ofPattern("MMM  d HH:mm:ss");
