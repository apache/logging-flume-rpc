...
public class TestAvroEventDeserializer {
    ...
    static {
        ...
        Schema.Field field = new Schema.Field("foo", Schema.create(Schema.Type.STRING), "", null);
    ...
    public void resetTest() throws IOException {
        ...
        EventDeserializer deserializer =
                desBuilder.build(new Context(), new ResettableFileInputStream(tempFile, tracker));
    ...
    public void testSchemaLiteral() throws IOException {
        ...
        Context context = new Context();
        context.put(
                AvroEventDeserializer.CONFIG_SCHEMA_TYPE_KEY, AvroEventDeserializer.AvroSchemaType.LITERAL.toString());
