...
public class ReliableSpoolingFileEventReader implements ReliableEventReader {
     ...
     */
    private ReliableSpoolingFileEventReader(
            File spoolDirectory,
            ...
            boolean annotateBaseName,
            String baseNameHeader,
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Initializing {} with directory={}, metaDir={}, " + "deserializer={}", new Object[] {
                ReliableSpoolingFileEventReader.class.getSimpleName(), spoolDirectory, trackerDirPath, deserializerType
            });
        }

        // Verify directory exists and is readable/writable
        Preconditions.checkState(
                spoolDirectory.exists(), "Directory does not exist: " + spoolDirectory.getAbsolutePath());
        Preconditions.checkState(
                spoolDirectory.isDirectory(), "Path is not a directory: " + spoolDirectory.getAbsolutePath());
    ...
    private List<File> getCandidateFiles(final Path directory) {
        ...
        try {
            ...
            logger.error(
                    "I/O exception occurred while listing directories. " + "Files already matched will be returned. "
                            + directory,
                    e);
    ...
    public static class Builder {
        ...
        public ReliableSpoolingFileEventReader build() throws IOException {
            return new ReliableSpoolingFileEventReader(
                    spoolDirectory,
                    completedSuffix,
                    includePattern,
                    ignorePattern,
