...
public abstract class AbstractAvroEventSerializer<T> implements EventSerializer, Configurable {
    ...
    public void configure(Context context) {
        ...
        int syncIntervalBytes = context.getInteger(SYNC_INTERVAL_BYTES, DEFAULT_SYNC_INTERVAL_BYTES);
        String compressionCodec = context.getString(COMPRESSION_CODEC, DEFAULT_COMPRESSION_CODEC);
