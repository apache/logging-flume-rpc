...
public class ThriftRpcClient extends SSLContextAwareAbstractRpcClient {
    ...
    public void append(Event event) throws EventDeliveryException {
        ...
        try {
            ...
            final ThriftFlumeEvent thriftEvent =
                    new ThriftFlumeEvent(event.getHeaders(), ByteBuffer.wrap(event.getBody()));
    ...
    public void appendBatch(List<Event> events) throws EventDeliveryException {
        ...
        try {
            ...
            client = connectionManager.checkout();
            final List<ThriftFlumeEvent> thriftFlumeEvents = new ArrayList<ThriftFlumeEvent>();
            ...
            while (eventsIter.hasNext()) {
                ...
                if (!thriftFlumeEvents.isEmpty()) {
                    doAppendBatch(client, thriftFlumeEvents).get(requestTimeout, TimeUnit.MILLISECONDS);
                }
            }
        } catch (Throwable e) {
            if (e instanceof ExecutionException) {
            ...
            public Void call() throws Exception {
                ...
                if (status != Status.OK) {
                    throw new EventDeliveryException(
                            "Failed to deliver events. Server " + "returned status : " + status.name());
                }
                return null;
            }
        });
    ...
    public void configure(Properties properties) throws FlumeException {
        ...
        try {
            ...
            if (!(protocol.equalsIgnoreCase(BINARY_PROTOCOL) || protocol.equalsIgnoreCase(COMPACT_PROTOCOL))) {
     ...
     */
    private static SSLContext createSSLContext(String truststore, String truststorePassword, String truststoreType)
    ...
    private static TSocket createSSLSocket(
            SSLSocketFactory factory,
            String host,
            int port,
            int timeout,
            Set<String> excludeProtocols,
            Set<String> includeProtocols,
            Set<String> excludeCipherSuites,
            Set<String> includeCipherSuites)
            throws FlumeException {
        try {
