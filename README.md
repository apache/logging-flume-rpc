...
* `flume-embedded-agent`: a stable public API for embedding a Flume agent in an application.

Apache Flume RPC is open-sourced under the Apache Software Foundation License v2.0.
